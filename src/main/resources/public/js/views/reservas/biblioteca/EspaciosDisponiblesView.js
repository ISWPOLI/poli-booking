define([ 'jquery', 'underscore', 'backbone',
	...
	var EspaciosDisponiblesView = Backbone.View.extend({
		...
		events:{
			"load #body": "generarTabla"
		},

		generarTabla : function genera_tabla() {
//			Obtener la referencia del elemento body
			var body = document.getElementById("uno");
			var arr =['Espacio','Fecha',"Hora Inicio","Hora Fin","Disponible"];
			...
			for (var i = 0; i < 5; i++) {
				...
				for (var j = 0; j < 5; j++) {
					...
					if(j<4){
						...
						var texto=document.createTextNode("Reservar");
